...
var game = {
    ...
    **/
    module: function(name) {
        ...
        if (name === 'engine.core') {
            // THis line fixes the pandatool@2.0.4 bug at production runtime in the browser
            // GET http://example.com/path_to_game/engine/debug.js  game.min.js:2
            // Uncaught to load module engine.debug at engine/debug.js required from engine.core 
            if (!this.config.ignoreModules) { this.config.ignoreModules = ["engine.debug"]; }
            ...
            // console.log("core.js: this",this);
            // console.log("core.js: this.config",this.config);        
            // console.log("core.js: this.config.ignoreModules", this.config.ignoreModules);
            // console.log("core.js: this.current.requires", this.current.requires);
            this.body(function() {});
        }
        return this;
    },
